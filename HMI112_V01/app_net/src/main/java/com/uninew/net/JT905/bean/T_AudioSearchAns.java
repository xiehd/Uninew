...
public class T_AudioSearchAns extends BaseBean{

    private int responseSerialNumber;//应答流水号
    private int packetSize;//包大小
    private int offset;//偏移量
    private List<Integer> queryResults;//检索项，音视频ID列表
    private int audioVideoId;//音视频ID

    public T_AudioSearchAns() {

    }

    public T_AudioSearchAns(int responseSerialNumber, int packetSize, int offset, List<Integer> queryResults) {
    ...
    @Override
    public int getMsgId() {
        return BaseMsgID.STORE_AUDIO_SEARCH_ANS;
    }
