...
//    WIFI_STATE_UNKNOWN：未知网卡状态
    ...
    public boolean connectConfiguration(WifiConfiguration wcg) {
        // 连接配置好的指定ID的网络
        boolean reult = mWifiManager.enableNetwork(wcg.networkId,
                true);
        return reult;
    }
    ...
    public boolean addNetwork(WifiConfiguration wcg) {
        ...
        boolean reult = mWifiManager.enableNetwork(wcgID, true);
        return reult;
    }
    ...
    // wifi热点开关
    public boolean setWifiApEnabled(boolean enabled,String name,String passworld) {
        ...
        try {
            ...
            apConfig.SSID = name;
            //配置热点的密码
            apConfig.preSharedKey= passworld;
            //通过反射调用设置热点
